...
@section('content2')
    <div class="row">
        <div class="col-12">
            <form id="form_create_post" method="post" action="{{route('admin.subject.update')}}" enctype="multipart/form-data">
                <div class="card p-3">
                    @csrf
                    <input type="hidden" name="id" value="{{$data->id}}">
                    <div class="mb-3">
                        <label for="simpleinput" class="form-label">Tên môn học </label>
