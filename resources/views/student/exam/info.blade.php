        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <!-- project card -->
                        <div class="card card-body  d-flex justify-content-center w-100" style="justify-content: center !important;">
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                <a class="btn btn-primary" style="margin-right:10px" href="{{route('student.exam.detail')}}">Thử lại</a>
